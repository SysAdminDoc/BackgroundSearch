...
![Version](https://img.shields.io/badge/version-v2.1.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Platform](https://img.shields.io/badge/platform-Python-lightgrey)
...
- **20 Search Engine Presets** — Google, Bing, DuckDuckGo, YouTube, Reddit, GitHub, Amazon, Perplexity, and more
...
- Highlight any text on a page, right-click, and pick a search engine. The result opens in a background tab next to your current tab
